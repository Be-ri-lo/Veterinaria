...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { date: @history.date, description: @history.description, height: @history.height, weight: @history.weight } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { date: @history.date, description: @history.description, height: @history.height, weight: @history.weight } }
